...
public class GeneralRepository {
    ...
    private Object executeInsert(Object singleRow, Connection dbConnection) throws Exception{
        ...
        try {
                ...
                TableInfo tableInfo = ConfigManager.getInstance().getTableInfo(singleRow.getClass());
                Class type = tableInfo.getKeyType(tableInfo.getSinglePrimaryKey());
    ...
    private boolean isInvalidForInsertOrUpdate(Object t)throws Exception{
        ...
        return tableInfo != null &&
                ...
                ReflectUtility.isPrimaryKeyEmpty(t, tableInfo.getSinglePrimaryKey());
    }
    ...
    private void updateObjectWithAutoGeneratedKey(Object o, Object autoGeneratedKey) throws Exception{
        ...
        TableInfo tableInfo =  ConfigManager
                                            .getInstance()
                                                .getTableInfo(o.getClass());

        ReflectUtility.mapValue(o
                , tableInfo.getSinglePrimaryKey()
                , tableInfo.getClassKeyType(tableInfo.getSinglePrimaryKey())
                , autoGeneratedKey);
    }
